...
import { 
  ...
  Trophy, AlertCircle, CloudSun, Calendar, TimerReset, Utensils
} from 'lucide-react';
...
export type WidgetType = 
  ...
  | 'weather' | 'schedule' | 'calendar' | 'lunchCount';
...
export const TOOLS: ToolMetadata[] = [
  ...
  { type: 'lunchCount', icon: Utensils, label: 'Lunch', color: 'bg-orange-600' },
];
