...
describe('useGoogleDrive', () => {
  ...
  describe('uploadBackgroundToDrive', () => {
    it('throws error if driveService is not available', async () => {
      mockUseAuth.mockReturnValue({
        googleAccessToken: null,
        refreshGoogleToken: mockRefreshGoogleToken,
        user: null,
  ...
  describe('getUserBackgroundsFromDrive', () => {
    it('returns empty array if driveService is not available', async () => {
      mockUseAuth.mockReturnValue({
        googleAccessToken: null,
        refreshGoogleToken: mockRefreshGoogleToken,
        user: null,
  ...
  describe('getDriveFileTextContent', () => {
    it('returns null if driveService is not available', async () => {
      mockUseAuth.mockReturnValue({
        googleAccessToken: null,
        refreshGoogleToken: mockRefreshGoogleToken,
        user: null,
