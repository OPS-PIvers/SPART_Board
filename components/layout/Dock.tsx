...
import { WidgetType, WidgetData, MiniAppItem, DockFolder } from '../../types';
              ...
              {dockItems.length > 0 ? (
                <>
                  ...
                  {session?.isActive && (
                    <>
                      ...
                      >
                        ...
                        <DockLabel globalStyle={globalStyle}>Live</DockLabel>
                      </button>
                  ...
                  >
                    ...
                    <DockLabel globalStyle={globalStyle}>
                  ...
                  {canAccessFeature('magic-layout') && (
                    ...
                    >
                      ...
                      <DockLabel globalStyle={globalStyle}>Magic</DockLabel>
                    </button>
                  )}
                  ...
                  >
                    ...
                    <DockLabel globalStyle={globalStyle}>Hide</DockLabel>
                  </button>
                </>
              ) : (
