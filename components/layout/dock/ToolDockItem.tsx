                ...
                {minimizedWidgets.map((widget) => (
                  ...
                  >
                    ...
                    <button
                      ...
                      className="p-1 text-slate-500 hover:text-red-600 hover:bg-red-50/50 rounded-md transition-colors opacity-0 group-hover:opacity-100 touch-target-expand"
        ...
        >
          ...
          {isEditMode && (
            <button
              ...
              className="absolute -top-2 -right-2 z-controls bg-red-500 text-white rounded-full p-1 shadow-md hover:scale-110 transition-transform animate-in zoom-in duration-200 touch-target-expand"
