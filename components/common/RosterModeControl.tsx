      ...
      {rosterMode === 'class' && (
        <div className="px-2 py-1.5 bg-blue-50/50 border border-blue-100 rounded-lg flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[10px] font-bold text-blue-700 uppercase tracking-tight truncate max-w-[150px]">
              {activeRoster
          ...
          {activeRoster && (
            <span className="text-[8px] font-black text-blue-400 bg-white px-1.5 py-0.5 rounded-md border border-blue-100 whitespace-nowrap">
