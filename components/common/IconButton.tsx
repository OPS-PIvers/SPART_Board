...
export const IconButton = forwardRef<HTMLButtonElement, IconButtonProps>(
  (
    ...
    const baseStyles =
      'relative touch-target-expand flex items-center justify-center transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-blue-primary disabled:opacity-50 disabled:cursor-not-allowed';
