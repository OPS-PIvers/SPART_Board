                    ...
                    {editingConfig === tool.type && (
                      <div className="p-4 border-b border-slate-100 last:border-0">
                        <h4 className="text-xs font-black text-brand-blue-dark uppercase mb-3 flex items-center gap-2">
                          <Settings className="w-3 h-3" /> {tool.label}{' '}
                          Configuration
                        </h4>
                                  ...
                                  <div>
                                    ...
                                    {isSchumannIdMalformed && (
                                      <p className="text-xxs text-red-600 font-bold mt-1">
                                        Warning: Enter only the ID, not the full
                                        URL.
                                      </p>
                                    )}
                                  </div>
                                ...
                                <>
                                  <div>
                                      ...
                                      <button
                                        ...
                                        className={`flex-1 py-1.5 text-xxs font-bold rounded transition-colors ${
                                          config.fetchingStrategy ===
                                            'client' || !config.fetchingStrategy
                                    ...
                                    <p className="text-xxs text-slate-400 mt-1">
                                      <strong>Client:</strong> Each user fetches
                                      data directly (higher API usage).
                                      <br />
                                      <strong>Admin Proxy:</strong> Admin
                                      fetches data, users sync from database
                                      (saves API calls).
                                    </p>
                                  </div>
                                  ...
                                  <div>
                                    ...
                                    <input
                                      ...
                                      max="1440"
                                      value={
                                        config.updateFrequencyMinutes ?? 15
                                      }
                                      onChange={(e) => {
                            ...
                            {(() => {
                              ...
                              return (
                                <div>
                                  ...
                                  <p className="text-xxs text-slate-400 mt-1">
                                    <strong>Standard:</strong> Uses
                                    browser-local OCR (no API usage).
                                    <br />
                                    <strong>Gemini:</strong> Uses Gemini 3 Flash
                                    for higher accuracy (uses AI limits).
                                  </p>
                                </div>
                              );
                            })()}
                        ...
                        {![
                          ...
                          <p className="text-xs text-slate-500 italic">
                            No additional configuration available for this
                            widget.
                          </p>
                        )}
                      </div>
