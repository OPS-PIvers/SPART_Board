...
interface LunchCountConfigProps {
  config: LunchCountGlobalConfig;
  onChange: (config: LunchCountGlobalConfig) => void;
}

export const LunchCountConfig: React.FC<LunchCountConfigProps> = ({
  config,
  onChange,
}) => {
