...
import { X, Plus, Sparkles, Edit, Trash2 } from 'lucide-react';
          ...
          <div className="bg-white w-full max-w-2xl h-[80vh] rounded-2xl shadow-2xl overflow-hidden flex flex-col">
            <LibraryManager
              ...
              onSave={async () => {
                ...
                onShowMessage('success', 'Routine saved to library');
              }}
        ...
        <ConfirmDialog
          ...
          onConfirm={async () => {
            try {
              ...
              onShowMessage('success', 'Routine deleted successfully');
            } catch (error) {
