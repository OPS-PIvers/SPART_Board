...
export const TextSettings: React.FC<{ widget: WidgetData }> = ({ widget }) => {
  ...
  const templates = [
    {
      name: 'Integrity Code',
      icon: ShieldCheck,
      content: '<b>The Integrity Code</b><br/>I promise that the work I am doing today is my own. I have not received unauthorized help, and I will not share assessment details with others.<br/><br/><i>Signed: ________________</i>'
    },
    {
      name: 'Spartan Scholar',
      icon: Star,
      content: '<b>Spartan Scholar Code</b><br/>• I am ready to learn.<br/>• I respect my peers.<br/>• I strive for excellence.<br/>• I own my actions.'
    },
    {
      name: 'Speaking Frames',
      icon: MessageSquare,
      content: '<b>Speaking Scaffolds</b><br/>• I agree with ___ because...<br/>• I respectfully disagree with ___ since...<br/>• To build on what ___ said...<br/>• Can you explain what you meant by...?'
    },
    {
      name: 'Writing Frame',
      icon: FileText,
      content: '<b>Summary Frame</b><br/>In today\'s lesson, we learned about ____. One important detail was ____. This is significant because ____.'
    }
  ];
  ...
  return (
    <div className="space-y-6">
      <div>
        <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-3 block">Templates</label>
        <div className="grid grid-cols-2 gap-2">
          {templates.map(t => (
            ...
            >
              ...
              <span className="text-[9px] font-bold text-slate-700">{t.name}</span>
            </button>
          ))}
        </div>
      </div>
      ...
      <div>
        <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-3 block">Background Color</label>
      ...
      <div>
        ...
        <div className="flex items-center gap-4">
          ...
          />
          <span className="w-8 text-center font-mono font-bold text-slate-700 text-xs">{widget.config.fontSize}</span>
        </div>
      </div>
    </div>
  );
