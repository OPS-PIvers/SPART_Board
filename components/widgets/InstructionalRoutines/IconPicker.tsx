...
export const IconPicker: React.FC<{
  ...
  return (
    <div className="relative">
      ...
      {isOpen && (
        <div className="absolute top-full left-0 mt-2 z-modal-deep-content bg-white border border-slate-200 shadow-2xl rounded-2xl p-3 w-64 animate-in zoom-in-95 duration-200">
