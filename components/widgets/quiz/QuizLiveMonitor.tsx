          ...
          {responses.length > 0 && (
            <div className="space-y-2 mt-2">
              <div className="flex items-center justify-between border-b border-brand-blue-primary/10 pb-1">
                <span className="text-brand-blue-primary/60 font-black uppercase tracking-widest text-xxs">
                  Roster Progress
                </span>
                <span className="text-brand-blue-primary/40 font-bold text-xxs">
  ...
  return (
    ...
    >
      ...
      >
        ...
        {warnings > 0 && (
          <span
            className="flex items-center gap-1 bg-red-100 text-red-700 px-2 py-0.5 rounded text-xxs uppercase font-black shrink-0 animate-in zoom-in duration-300"
