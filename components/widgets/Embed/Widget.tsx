      ...
      content={
        <div className="w-full h-full bg-transparent flex flex-col overflow-hidden relative group/embed-content">
          {((displayMode === 'url' && url.trim()) ||
            ...
            <div className="absolute top-2 right-2 z-decorator flex items-center gap-1 opacity-0 group-hover/embed-content:opacity-100 focus-within:opacity-100 transition-opacity">
