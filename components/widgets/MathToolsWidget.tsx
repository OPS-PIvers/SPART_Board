    ...
    <WidgetLayout
      ...
      content={
        <>
          {/* ---- Grade filter ---- */}
          <div
            className="flex items-center gap-1 border-b border-slate-100 bg-white/60 shrink-0 overflow-x-auto no-scrollbar"
          ...
          >
            ...
            {PALETTE_SECTIONS.map((section) => {
              ...
              return (
                <div
                  key={section.id}
                  style={{ marginBottom: 'min(14px, 3cqmin)' }}
                >
                  {/* Section header */}
                  <div
                  ...
                  {(section.mode === 'sticker-whole' ||
                    ...
                    <div
                      ...
                      style={{
                        gridTemplateColumns:
                          'repeat(auto-fill, minmax(min(120px, 40cqw), 1fr))',
                    ...
                    >
                      {visibleTools.map((tool) => (
                        <button
                          ...
                          className={`flex flex-col items-center bg-white border border-slate-100 rounded-xl shadow-sm transition-all group active:scale-95 ${
                            section.mode === 'sticker-whole'
                            ...
                            >
                              {subItems.map((item) => (
                                <button
                                  key={item.id}
                                  onClick={() =>
                                    handleSpawnPiece(tool.type, item)
                                  }
                                  ...
                                  style={{
                                    ...
                                    padding:
                                      'min(4px, 1cqmin) min(8px, 1.8cqmin)',
                                  }}
                                >
                                  {item.emoji && (
                                    <span
