...
export const WIDGET_SCALING_CONFIG: Record<WidgetType, ScalingConfig> = {
  ...
  drawing: { baseWidth: 400, baseHeight: 350, canSpread: true, skipScaling: true },
  ...
  classes: { baseWidth: 600, baseHeight: 500, canSpread: true, skipScaling: true },
  ...
  stickers: { baseWidth: 600, baseHeight: 500, canSpread: true, skipScaling: true },
  sticker: { baseWidth: 200, baseHeight: 200, canSpread: false },
  'seating-chart': { baseWidth: 600, baseHeight: 500, canSpread: true, skipScaling: true },
  ...
  smartNotebook: { baseWidth: 600, baseHeight: 500, canSpread: true, skipScaling: true },
};
