...
| Note (text)                 | ⬜ Not started           | Default text size/style per building                                                 |
...
| Random                      | ⬜ Not started           | Elimination mode toggle, visual style defaults                                       |
...
| Traffic Light               | ⬜ Not started           | Automated triggers, default active state                                             |
