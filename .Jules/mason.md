...
## 2026-01-29 - [Unchecked Backend in Dev] **Bottleneck:** Dev branches allow broken backend code as they only build frontend. **Fix:** Added functions installation and build steps to `firebase-dev-deploy.yml` and added helper scripts to `package.json`.
