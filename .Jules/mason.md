...
## 2026-02-05 - [Deployment Reliability] **Bottleneck:** Deployment pipeline was skipping tests and using fragmented commands. Functions tests were not configured. **Fix:** Enabled functions testing with Vitest, standardized `validate` script for full-stack verification, and unified `firebase-deploy.yml` to run all checks before an atomic deploy.
