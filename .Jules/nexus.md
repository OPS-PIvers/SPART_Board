...
### Poll -> Scoreboard (Award Points)

**Description:** Award points to Scoreboard teams based on votes from a Poll.
**Implementation:** `ScoreboardWidget.tsx` matches Poll options to Team names and adds votes to the score.
**Configuration:** Button "Award Points" in Scoreboard Settings (Import from Poll).
