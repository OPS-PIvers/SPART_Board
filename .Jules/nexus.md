...
**Description:** Import poll results directly into the scoreboard, converting options to teams and votes to scores.
**Implementation:** `ScoreboardWidget.tsx` queries for active `poll` widgets and maps options to teams.
**Configuration:** "Import from Poll" button in Scoreboard Settings.
