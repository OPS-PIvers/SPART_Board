...
- **Scoreboard & Randomizer (additional automations):** Beyond the existing *Randomizer -> Scoreboard (Team Builder)* handoff documented above, we do not plan further automatic or bi-directional integrations between these widgets, to maintain their simplicity.
