...
**Implementation:** `ScoreboardWidget.tsx` finds active `poll` widgets and imports options as teams, using vote counts as initial scores.
**Configuration:** Enabled via "Import from Poll" button in Scoreboard Settings.
